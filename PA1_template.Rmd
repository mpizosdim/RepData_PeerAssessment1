...
The mean of the total number of steps taken per day is `r MeanStep`. The median value is `r MedianStep`.It can be observed that the median value changed slightly after filling the NA values. Furthermore, median and mean value are identical now.
